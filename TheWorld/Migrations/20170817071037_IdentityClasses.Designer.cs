...
namespace TheWorld.Migrations
{
    ...
    [Migration("20170817071037_IdentityClasses")]
    partial class IdentityClasses
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("TheWorld.Models.WorldContextSeedData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("WorldContextSeedData");
                });
            ...
            modelBuilder.Entity("TheWorld.Models.WorldUser", b =>
                {
                    b.HasOne("TheWorld.Models.WorldContextSeedData", "FirstTrip")
                        .WithMany()
                        .HasForeignKey("FirstTripId");
                });
        }
    }
}
